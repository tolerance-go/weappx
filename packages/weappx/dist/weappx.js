    ...
    /******/ [
      ...
      /***/ function(module, exports, __webpack_require__) {
        ...
        function create() {
          ...
          var _extraMiddlewares = [
            _tunkMiddleware2.default,
            _actionTakeMiddleware.actionTakeMiddleware,
          ];
          ...
          function init(options) {
            ...
            if (extraMiddlewares) {
              (0, _assert2.default)(
                Array.isArray(extraMiddlewares),
                'extraMiddlewares type must be Array'
              );
          ...
          function model(options) {
            ...
            (0, _assert2.default)(
              undefined === this._models[namespace],
          ...
          function start() {
            ...
            (0, _assert2.default)(
              _connector,
              '[weappx.start]:connector is required, please call [weappx.init] first'
            );
            ...
            var store = (0, _redux.createStore)(
              rootReducer,
              _redux.applyMiddleware.apply(undefined, _toConsumableArray(_extraMiddlewares))
            );
              ...
              var _loop2 = function _loop2(actionName) {
                ...
                _this3.dispatcher[namespace][actionName] = function() {
                  ...
                  return store.dispatch(
                    (_actions$namespace = _this3._actions[namespace])[actionName].apply(
                      _actions$namespace,
                      arguments
                    )
                  );
...
*/
      ...
      /***/ function(module, __webpack_exports__, __webpack_require__) {
        ...
        /* WEBPACK VAR INJECTION */ (function(global, module) {
          ...
          /* WEBPACK VAR INJECTION */
        }.call(__webpack_exports__, __webpack_require__(20), __webpack_require__(15)(module)));
